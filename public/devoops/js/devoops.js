...
function LoadAjaxContentPOST(url,datos){
	$('.preloader').show();
	$.ajax({
		mimeType: 'text/html; charset=utf-8', // ! Need set mimeType only when run from local file
		url: url,
...
//	$('.dropdown:has(li:has(a.active)) > ul').css("display", "block");
	$('.main-menu').on('click', 'a', function (e) {
		...
		if ($(this).hasClass('ajax-link-nok')) {
			e.preventDefault();
        ...
        $('#content').on('click', 'input', function (e) {
                ...
                if ($(this).hasClass('ajax-link-nok') && !$(this).hasClass('modal-ajax')) {
//                    if($("#resgistrar-actividad-form").length){
//                        $("#resgistrar-actividad-form").trigger("click");
//                    }
                    e.preventDefault();
                    ...
                    window.location.hash = url;
                    LoadAjaxContentPOST(url, data);
                }
            //}
        });
        
        // Cargar todos los enlaces con clase ajax-link-nok
	...
	$('#about').on('mouseleave', function(){
        ...
        $("#registrar-actividad").click(function(){
            $("#resgistrar-actividad-form").trigger("click");
        });
        /*
...
//                $.ajax({
//                    url: '/seguimiento/horarios/obtenerfichas',
//                    type: 'POST',
