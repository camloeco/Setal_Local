...
trait AuthenticatesAndRegistersUsers
{
    ...
    {
        $this->validate($request, array('par_identificacion' => 'required', 'password' => 'required'));
        ...
        return redirect($this->loginPath())->withInput($request->only('par_identificacion', 'remember'))->withErrors(array('email' => $this->getFailedLoginMessage()));
    }
    
    protected function getFailedLoginMessage()
    {
        return 'Los datos de acceso no son validos o su usuario se encuentra deshabilitado. Por favor validar con el administrador';
    }
