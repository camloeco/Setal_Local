...
{!! getHeaderMod('Seguimiento a proyectos','Importar fichas') !!}
...
<div class="row">
    ...
    <div class="col-xs-12 col-sm-12">
        <div class="box ui-draggable ui-droppable">
            ...
            <div class="box-content">
                {!! Form::open(array("url" => url("seguimiento/participante/cargafichas"), "method"=>"post", "files"=> true, "id"=>"formuploadajax","class"=>"form-horizontal")) !!}
