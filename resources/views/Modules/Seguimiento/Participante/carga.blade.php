...
{!! getHeaderMod('Seguimiento a proyectos','Importar participantes') !!}
...
<div class="row">
        ...
        <div class="box ui-draggable ui-droppable">
            ...
            <div class="box-content">
                ...
                <div class="alert alert-danger">
                    <button data-dismiss="alert" class="close" type="button">×</button>
                    <ul>
                        @foreach($mensaje['errores']['errores'] as $key => $val)
                        <li>
                            <strong></strong> {{ $val }}
                        </li>
                        @endforeach
    ...
    <div class="col-xs-12 col-sm-12">
        <div class="box ui-draggable ui-droppable">
            ...
            <div class="box-content">
                {!! Form::open(array("url" => url("seguimiento/participante/carga"), "method"=>"post", "files"=> true, "id"=>"formuploadajax","class"=>"form-horizontal")) !!}

                <div class="form-group">
                    {!! Form::label("cargo","Tipo de participante", 
                    array("for"=>"cargo", "class"=>"control-label col-md-3")) !!}
                    <div class="col-sm-4">
