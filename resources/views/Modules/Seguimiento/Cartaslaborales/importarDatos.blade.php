...
@section('content')
{!! getHeaderMod('Cartas laborales','Importar datos') !!}
<div class="row">
    <div class="col-xs-12 col-sm-12">
        <div class="box ui-draggable ui-droppable">
            ...
            <div class="box-content">
                    ...
                    <div class="row">
                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                            <div class="alert alert-default" style="background-color:#309591;color:white;">
                                ...
                                <h5>Registros actualizados: <strong>{{ $arregloMensajes['registrosActualizados'] }}</strong></h5>
                ...
                <div class="row">
                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                        <form enctype="multipart/form-data" action="{{ url('seguimiento/cartaslaborales/importardatos') }}" method="POST">
                            <label>Seleccionar archivo</label>
                            <input required style="padding-bottom: 15px;" class="form-control-static" name="archivo" class="" type="file">
                            <input type="hidden" name="_token" value="{{ csrf_token() }}">
                            <input class="btn btn-success btn-xs" type="submit" value="Cargar datos">
                            <a href="{{ asset('Modules/Seguimiento/Formatos/formatoImportarDatosContratos.xlsx') }}" class="btn btn-warning btn-xs">Descargar formato</a>
                        </form>
                    </div>
                </div>
            </div>
