...
<html lang="en">
    <head>
        <meta charset="utf-8">
        <title>SETALPRO / Seguimiento etapa lectiva y productiva</title>
...
<!--        <link href='http://fonts.googleapis.com/css?family=Righteous' rel='stylesheet' type='text/css'>-->
        ...
        <link href="{{ asset('devoops/css/style_v2.css?v=2')}}" rel="stylesheet">
...
<!--                    <div class="preloader--">
        ...
        <script src="{{ asset('js/global.js?v=7')}}"></script>
